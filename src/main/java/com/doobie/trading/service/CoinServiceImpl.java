...
import com.doobie.trading.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService{
    ...
    public List<Coin> getCoinList(int page) {
        ...
        {
            throw new RuntimeException("Error occurred while fetching market data!!",e);
    ...
    public String getMarketChart(String coinId, int days) {
        ...
        try
        {
            ...
            throw new RuntimeException("Error occurred while fetching coin data!!", e);
        }
    }
    ...
    public String searchCoin(String keyword) {
        ...
        try
        {
            ...
            throw new RuntimeException("coin not found", e);
        }
    }
